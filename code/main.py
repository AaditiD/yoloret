...
flags.DEFINE_enum_class(
    'backbone',
    default=BACKBONE.MOBILENETV2x75,
    enum_class=BACKBONE,
    help=
    "Select network backbone, One of {'MOBILENETV2x75','MobileNetV2x14','EFFICIENTNETB3'}"
)
...
#                      lower_bound=0,
#                      help="Train batch size")
flags.DEFINE_integer('num_scales',
                     default=3,
...
flags.DEFINE_string(
    'train_unfreeze',
    default=None,
    help="Frozen Backbone trained model path")
flags.DEFINE_enum_class(
    'mode',
    default=MODE.TRAIN,
    enum_class=MODE,
...
flags.DEFINE_bool('quantize', default=False,help="Whether run quantize aware training")
